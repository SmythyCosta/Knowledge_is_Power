...
$q = "SELECT COUNT(history.id) AS num, pages.id, pages.title FROM pages, history WHERE pages.id=history.item_id AND history.type='page' GROUP BY (history.item_id) ORDER BY num DESC LIMIT 10";
