...
//				$_SESSION['reg_user_id']  = $uid;		
				...
				$body = "Thank you for registering at <whatever site>. Blah. Blah. Blah.\n\n";
                                ...
                                $mail->setFrom('smythy.costa@hotmail.com', 'Registration Confirmation');
                                $mail->addAddress($_POST['email']);  //verificar o email.
                                $mail->Subject = utf8_decode('Registration Confirmation');
                                $mail->Charset = 'UTF-8';
